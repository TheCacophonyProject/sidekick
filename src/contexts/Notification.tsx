...
const removeNotificationAfterDuration = (id: string, duration: number) => setTimeout(() => {
  setNotifications(notifications().filter((notification) => notification.id !== id))
}, duration
);

const logAction = (type: NotifcationType) => (message: string, details?: string, duration = defaultDuration) => {
  const id = generateID();
  setNotifications([
    ...notifications(),
...
export { logError, logSuccess, logLoading, keepNotification, hideNotification, notifications }
